...
import { PRIORITY_STYLES, TASK_TYPE } from "../utils"; // Fixed typo here
...
const Trash = () => {
  ...
  const deleteRestoreHandler = () => {
    if (type === "delete") {
      ...
      console.log(`Task ${selected} deleted`);
    } else if (type === "restore") {
      // Handle restoring the selected task
      console.log(`Task ${selected} restored`);
    } else if (type === "deleteAll") {
      // Handle deleting all tasks
      console.log("All tasks deleted");
    } else if (type === "restoreAll") {
      // Handle restoring all tasks
